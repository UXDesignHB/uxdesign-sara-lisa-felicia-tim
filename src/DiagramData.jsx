...
const data2 = [
  {
    ...
    videotext: "Som ett resultat av den globala uppvärmningen minskar arktiska havsisar cirka 13% varje årtionde. De senaste 30 åren har 95% av Arktis äldsta och tjockaste isar smält bort. Redan före år 2050 riskerar Arktis att vara helt isfritt i september. Smältande havsisar hotar ekosystemet, och gör det svårt för djur som isbjörnar och valar att överleva. Grafen ovan visar storleken på den arktiska havsisen sedan observationer startade år 1946. Visualiseringen till höger visar det hur den arktiska isen har förändrats sedan år 1979.",
    dataSource: "Data: NASA Scientific Visualization Studio"
  },
  {
    id: "2",
    title: "CO2-Utsläpp",
    ...
    graphtitle: "NU ÄR DET VARMARE ÄN NÅGONSIN",
    headingcolor: "var(--purple)",
    textcolor: "var(--co2purple)",
    videotitle: "VISUALITION ÖVER GLOBALA TEMPERATURAVVIKELSER",
    videotext: "Till följd av mänskliga aktiviteter har koldioxidhalten i atmosfären ökat med 50% på mindre än 200 år vilket orskar den globala uppvärmningen. Koldioxid (CO2) är en viktig värmefångande gas, eller växthusgas, som kommer från utvinning och förbränning av fossila bränslen. Exempel på fossila bränslen är naturgas, bensin, diesel och kol. Den visualiserade tidsserien visar hur distributionen och koncentrationen av koldioxid har förändrats sedan år 2002. De röda-gula områdena har höga koncentrationer av CO2, medan de blå-gröna visar en lägre koncentration.",
    dataSource: "Data: Atmospheric Infrared Sounder (AIRS)."
  },
  {
    id: "3",
    ...
    videotitle: "VISUALITION ÖVER GLOBALA TEMPERATURAVVIKELSER",
    videotext: "Havsnivåerna stiger till följd av den globala uppvärmningen. Att havsnivåerna stiger beror främst på att isarna och glaciärerna smälter när klimatet blir varmare, men det beror också på att varmt vatten tar mer plats än kallt vatten. Diagrammet visar hur havsnivåerna har förändrats över tid sedan år 1880. Satellitbilder visar att Grönland och Antarktis inlandsis smälter. Detta kan leda till att havsnivån stiger 1 m. Skulle isarna smälta helt skulle det innebära att havsnivån höjs 66 m. När havets medelnivå stiger påverkas kustlinje, städer och trafik. Visualiseringen till vänster visar hur kustområden påverkas för varje meter havsnivåhöjning, upp till 6 m. Den röda skuggan visar land som blir täckt av vatten.",
    dataSource: "Data: Center for Remote Sensing of Ice Sheets"
  },
  {
    id: "4",
    ...
    videotitle: "VISUALITION ÖVER GLOBALA TEMPERATURAVVIKELSER",
    videotext: "Globala temperaturer nådde sin högsta nivå någonsin år 2020 till följd av mänskligt utsläpp av växthusgaser. Uppskattningsvis påverkar mänskliga ageranden klimatet 170 gånger snabbare än naturliga faktorer. Grafen visar hur den globala temperaturen har förändrats sedan år 1880. Den globala medeltemperaturen ökning bidrar till effekter som värmeböljor, smältande havsisar och översvämningar. Den färgkodade kartan till vänster simulerar hur den globala yttertemperaturen har förändrats sedan 1884. De röda områdena är varmare än genomsnittet, medan de blåa är kallare än genomsnittet.",
    dataSource: "Data: NASA's Scientific Visualization Studio"
  },
];
